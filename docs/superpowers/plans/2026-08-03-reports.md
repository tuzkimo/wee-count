...
describe("async aggregations via mocked db", () => {
  ...
  it("getReportData orchestrates all four datasets", async () => {
    ...
    expect(d.netAsset.labels).toHaveLength(31);
...
function makeData(): any {
  return {
    label: "2026年8月", range: { start: new Date(2026, 7, 1), end: new Date(2026, 8, 1) },
    trend: { labels: ["2026-08-01", "2026-08-02"], income: [1, 2], expense: [0, 1] },
    totals: { income: 3, expense: 1, balance: 2 }, prevTotals: { income: 3, expense: 1, balance: 2 },
    breakdownExpense: {
...
const { unit, offset, loading, data, breakdownType, deltas, setUnit, shift } = useReports();
